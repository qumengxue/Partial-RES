...
# ------------------------------------------------------------------------
# ------------------------------------------------------------------------
# Modified from SMCA-DETR (https://github.com/gaopengcuhk/SMCA-DETR)
# ------------------------------------------------------------------------
...
class MultiheadAttention(Module):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor, key_padding_mask: Optional[Tensor] = None,
                need_weights: bool = True, attn_mask: Optional[Tensor] = None, gaussian=None) -> Tuple[Tensor, Optional[Tensor]]:
        r"""
    Args:
...
def multi_head_attention_forward(
    ...
    if gaussian is not None:
        attn_mask = attn_mask.repeat(1, gaussian[0].shape[0], 1)
        attn_mask[..., :gaussian[0].shape[1]] = attn_mask[..., :gaussian[0].shape[1]] + gaussian[0].permute(2, 0, 1)
    #
